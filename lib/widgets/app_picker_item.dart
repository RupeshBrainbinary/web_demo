...
class AppPickerItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget valueWidget = Padding(
      ...
      child: Text(
        ...
        style: Theme.of(context)
            .textTheme
            .subtitle1!
            .copyWith(color: Theme.of(context).hintColor,fontFamily: "ProximaNova"),
      ),
    );
    ...
    Widget trailingWidget =  Icon(Icons.arrow_drop_down,color: Theme.of(context).iconTheme.color,);
    if (loading) {
